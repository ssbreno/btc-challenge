...
import { BTCMarketUseCase } from '../use-case/btc-market.use-case';

export class BTCMarketController {
  ...
  private async checkBTCMarket(request: FastifyRequest, reply: FastifyReply): Promise<void> {
    try {
